...
function PoliticianPage() {
    ...
    const data = useFetchDateAggregateStockData(searchTerm,"politician"); 

    const [currentPage, setCurrentPage] = useState(1); // 현재 페이지 번호
    let posts = useFetchBlog(searchTerm,"politician",currentPage)
    ...
    const data2 = useFetchAggregateStockData(searchTerm,"politician",period); 
