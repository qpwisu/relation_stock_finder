...
function SectorPage() {
    ...
    const data = useFetchDateAggregateStockData(searchTerm,"sector"); 

    const [currentPage, setCurrentPage] = useState(1); // 현재 페이지 번호
    let posts = useFetchBlog(searchTerm,"sector",currentPage)
    ...
    const data2 = useFetchAggregateStockData(searchTerm,"sector",period); 
